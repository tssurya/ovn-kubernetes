...
const TaskEdgeInner = (0, mobx_react_1.observer)(({ element, startTerminalType = types_1.EdgeTerminalType.none, startTerminalClass, startTerminalStatus, startTerminalSize = 14, endTerminalType = types_1.EdgeTerminalType.none, endTerminalClass, endTerminalStatus, endTerminalSize = 14, className, nodeSeparation, selected, onSelect }) => {
    ...
    const edgeBackground = ((0, jsx_runtime_1.jsx)("path", { onClick: onSelect, className: (0, react_styles_1.css)(topology_components_1.default.topologyEdgeBackground, onSelect && 'pf-m-selectable'), d: edgePath }));
    return ((0, jsx_runtime_1.jsxs)("g", Object.assign({ "data-test-id": "task-handler", className: groupClassName }, { children: [selected ? edgeBackground : (0, jsx_runtime_1.jsx)(Layer_1.default, Object.assign({ id: const_1.TOP_LAYER }, { children: edgeBackground })), (0, jsx_runtime_1.jsx)("path", { d: edgePath, transform: "translate(0.5,0.5)", shapeRendering: "geometricPrecision", fillOpacity: 0 }), (0, jsx_runtime_1.jsx)(components_1.DefaultConnectorTerminal, { className: startTerminalClass, isTarget: false, edge: element, size: startTerminalSize, terminalType: startTerminalType, status: startTerminalStatus }), (0, jsx_runtime_1.jsx)(components_1.DefaultConnectorTerminal, { className: endTerminalClass, isTarget: true, edge: element, size: endTerminalSize, terminalType: endTerminalType, status: endTerminalStatus, startPoint: verticalLayout ? endPoint.clone().translate(0, -1) : endPoint.clone().translate(-1, 0) })] })));
});
const TaskEdge = (_a) => {
    ...
    return (0, jsx_runtime_1.jsx)(TaskEdgeInner, Object.assign({ element: element }, rest));
};
