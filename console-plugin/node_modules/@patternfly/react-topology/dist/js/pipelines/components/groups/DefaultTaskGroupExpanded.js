...
const DefaultTaskGroupExpanded = (0, mobx_react_1.observer)(({ className, element, collapsible, selected, onSelect, hover, label, secondaryLabel, showLabel = true, showLabelOnHover, hideDetailsAtMedium, status, GroupLabelComponent = NodeLabel_1.default, truncateLength, canDrop, dropTarget, onContextMenu, contextMenuOpen, dragging, dragNodeRef, badge, badgeColor, badgeTextColor, badgeBorderColor, badgeClassName, badgeLocation, labelOffset = 17, centerLabelOnEdge, labelIconClass, labelIcon, labelIconPadding, onCollapseChange, labelPosition, borderRadius = 16 }) => {
    ...
    (0, behavior_1.useAnchor)((0, react_1.useCallback)((node) => new TaskGroupSourceAnchor_1.default(node, verticalLayout, labelShown &&
    ...
    (0, behavior_1.useAnchor)((0, react_1.useCallback)((node) => new TaskGroupTargetAnchor_1.default(node, verticalLayout, labelShown &&
    ...
    const [labelX, labelY] = (0, react_1.useMemo)(() => {
    ...
    const groupLabel = labelShown ? ((0, jsx_runtime_1.jsx)("g", Object.assign({ ref: labelHoverRef, transform: isHover ? `scale(${labelScale})` : undefined }, { children: (0, jsx_runtime_1.jsx)(GroupLabelComponent, Object.assign({ element: element, boxRef: labelRef, className: topology_components_1.default.topologyGroupLabel, x: labelX * labelPositionScale, y: labelY * labelPositionScale, position: labelPosition, centerLabelOnEdge: centerLabelOnEdge, runStatus: status, paddingX: 8, paddingY: 5, dragRef: dragNodeRef ? dragLabelRef : undefined, status: element.getNodeStatus(), selected: selected, secondaryLabel: secondaryLabel, truncateLength: truncateLength, badge: badge, badgeColor: badgeColor, badgeTextColor: badgeTextColor, badgeBorderColor: badgeBorderColor, badgeClassName: badgeClassName, badgeLocation: badgeLocation, labelIconClass: labelIconClass, labelIcon: labelIcon, labelIconPadding: labelIconPadding, onContextMenu: onContextMenu, contextMenuOpen: contextMenuOpen, hover: isHover || labelHover, actionIcon: collapsible ? (0, jsx_runtime_1.jsx)(compress_alt_icon_1.default, {}) : undefined, onActionIconClick: () => onCollapseChange(element, true) }, { children: label || element.getLabel() })) }))) : null;
    return ((0, jsx_runtime_1.jsx)("g", Object.assign({ onContextMenu: onContextMenu, onClick: onSelect, className: groupClassName }, { children: (0, jsx_runtime_1.jsxs)(layers_1.Layer, Object.assign({ id: const_1.GROUPS_LAYER }, { children: [(0, jsx_runtime_1.jsx)("g", Object.assign({ ref: refs, onContextMenu: onContextMenu, onClick: onSelect, className: innerGroupClassName }, { children: (0, jsx_runtime_1.jsx)("rect", { x: bounds.x, y: bounds.y, width: bounds.width, height: bounds.height, className: topology_components_1.default.topologyGroupBackground, rx: borderRadius, ry: borderRadius }) })), groupLabel && isHover ? ((0, jsx_runtime_1.jsx)(layers_1.Layer, Object.assign({ id: const_1.TOP_LAYER }, { children: (0, jsx_runtime_1.jsx)("g", Object.assign({ className: innerGroupClassName }, { children: groupLabel })) }))) : (groupLabel)] })) })));
});
