...
const DefaultTaskGroupInner = (0, mobx_react_1.observer)((_a) => {
    ...
    if (element.isCollapsed()) {
        return ((0, jsx_runtime_1.jsx)(DefaultTaskGroupCollapsed_1.default, Object.assign({ element: element, shadowCount: collapsedShadowCount, onCollapseChange: handleCollapse, badge: badge || `${childCount}` }, rest)));
    }
    return (0, jsx_runtime_1.jsx)(DefaultTaskGroupExpanded_1.default, Object.assign({ element: element, badge: badge, onCollapseChange: handleCollapse }, rest));
});
const DefaultTaskGroup = (_a) => {
    ...
    return ((0, jsx_runtime_1.jsx)(DefaultTaskGroupInner, Object.assign({ element: element, badgeColor: badgeColor, badgeBorderColor: badgeBorderColor, badgeTextColor: badgeTextColor }, rest)));
};
