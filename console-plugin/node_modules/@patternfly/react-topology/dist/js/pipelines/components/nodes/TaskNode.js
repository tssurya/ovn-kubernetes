...
const TaskNodeInner = (0, mobx_exports_1.observer)((_a) => {
    ...
    (0, behavior_1.useAnchor)((0, react_1.useCallback)((node) => new anchors_1.TaskNodeSourceAnchor(node, detailsLevel, statusIconSize + 4, verticalLayout), 
    ...
    (0, behavior_1.useAnchor)((0, react_1.useCallback)((node) => new anchors_1.TaskNodeTargetAnchor(node, whenSize + whenOffset, detailsLevel, statusIconSize + 4, verticalLayout), 
    // Include scaleNode to cause an update when it changes
    // eslint-disable-next-line react-hooks/exhaustive-deps
