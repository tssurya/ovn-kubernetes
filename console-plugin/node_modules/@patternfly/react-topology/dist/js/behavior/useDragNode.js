...
const useDragNode = (spec, props) => {
    ...
    return (0, useDndDrag_1.useDndDrag)((0, react_1.useMemo)(() => {
        const sourceSpec = {
...
const withDragNode = (spec) => (WrappedComponent) => {
    const Component = (props) => {
        ...
        return (0, jsx_runtime_1.jsx)(WrappedComponent, Object.assign({}, props, { dragNodeRef: dragNodeRef }, dragNodeProps));
    };
