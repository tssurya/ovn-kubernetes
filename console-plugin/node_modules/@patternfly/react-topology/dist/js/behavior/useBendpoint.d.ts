...
export declare const withBendpoint: <DropResult, CollectedProps, Props = {}>(spec?: Omit<DragSourceSpec<DragObjectWithType, DragSpecOperationType<DragOperationWithType>, DropResult, CollectedProps, Props>, "type">) => <P extends WithBendpointProps & CollectedProps & Props>(WrappedComponent: import("react").ComponentType<P>) => import("react").FunctionComponent<Omit<P, "dragNodeRef"> & HocProps>;
export {};
