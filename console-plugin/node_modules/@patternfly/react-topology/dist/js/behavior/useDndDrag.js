...
const getOperation = (operation, event) => {
    ...
    return operation[getModifiers(event)] || operation[exports.Modifiers.DEFAULT];
};
...
const useDndDrag = (spec, props) => {
    const specRef = (0, react_1.useRef)(spec);
    specRef.current = spec;
    const propsRef = (0, react_1.useRef)(props != null ? props : EMPTY_PROPS);
    ...
    // source monitor
    const monitor = (0, react_1.useMemo)(() => {
        const sourceMonitor = {
    ...
    const createKeyHandlerId = (0, react_1.useCallback)((event = '') => `${event}.useDndDrag-${monitor.getHandlerId()}`, [monitor]);
    (0, react_1.useEffect)(() => () => {
    ...
    []);
    const refCallback = (0, useCallbackRef_1.default)((0, react_1.useCallback)((node) => {
        let ownerDocument;
        if (node) {
            ...
            () => {
                ...
                const updateOperation = (0, mobx_1.action)((event) => tslib_1.__awaiter(this, void 0, void 0, function* () {
                ...
                d3.select(ownerDocument)
                    .on(createKeyHandlerId('keydown'), (0, mobx_1.action)((event) => {
                    if (event.key === 'Escape') {
    ...
    const collected = (0, react_1.useMemo)(() => (0, mobx_1.computed)(() => (spec.collect ? spec.collect(monitor, propsRef.current) : {}), {
...
const withDndDrag = (spec) => (WrappedComponent) => {
    const Component = (props) => {
        ...
        return (0, jsx_runtime_1.jsx)(WrappedComponent, Object.assign({}, props, dndDragProps, { dndDragRef: dndDragRef }));
    };
