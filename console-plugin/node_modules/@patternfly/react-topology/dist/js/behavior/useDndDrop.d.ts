...
export declare const withDndDrop: <DragObject, DropResult = GraphElement<import("../types").ElementModel, any>, CollectedProps extends {} = {}, Props extends {} = {}>(spec: DropTargetSpec<DragObject, DropResult, CollectedProps, Props>) => <P extends WithDndDropProps & CollectedProps & Props>(WrappedComponent: import("react").ComponentType<P>) => import("react").FunctionComponent<Omit<P, "dndDropRef" & CollectedProps>>;
