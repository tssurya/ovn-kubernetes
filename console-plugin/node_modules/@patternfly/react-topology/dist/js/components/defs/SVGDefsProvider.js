 ...
 */
class SVGDefsProvider extends react_1.Component {
    constructor() {
        super(...arguments);
        this.defsRef = (0, react_1.createRef)();
        this.defs = {};
        this.contextValue = {
            addDef: (id, node) => {
    ...
    render() {
        return ((0, jsx_runtime_1.jsxs)(SVGDefsContext_1.default.Provider, Object.assign({ value: this.contextValue }, { children: [(0, jsx_runtime_1.jsx)(Defs_1.Defs, { ref: this.defsRef }), this.props.children] })));
    }
}
