...
const LayerContainer = ({ children }, ref) => {
    ...
    return ((0, jsx_runtime_1.jsx)("g", Object.assign({ ref: ref, transform: `translate(${x}, ${y})` }, commonAttrs, { children: children })));
};
exports.default = (0, mobx_react_1.observer)((0, react_1.forwardRef)(LayerContainer));
