...
const DefaultEdgeInner = (0, mobx_react_1.observer)(({ element, dragging, sourceDragRef, targetDragRef, dndDropRef, canDrop, dropTarget, edgeStyle, animationDuration, onShowRemoveConnector, onHideRemoveConnector, startTerminalType = types_1.EdgeTerminalType.none, startTerminalClass, startTerminalStatus, startTerminalSize = 14, endTerminalType = types_1.EdgeTerminalType.directional, endTerminalClass, endTerminalStatus, endTerminalSize = 14, tag, tagClass, tagStatus, children, className, selected, onSelect, onContextMenu }) => {
    ...
    return ((0, jsx_runtime_1.jsx)(layers_1.Layer, Object.assign({ id: dragging || hover ? const_1.TOP_LAYER : undefined }, { children: (0, jsx_runtime_1.jsxs)("g", Object.assign({ ref: edgeRef, "data-test-id": "edge-handler", className: groupClassName, onClick: onSelect, onContextMenu: onContextMenu }, { children: [(0, jsx_runtime_1.jsx)("path", { className: (0, react_styles_1.css)(topology_components_1.default.topologyEdgeBackground), d: backgroundPath, onMouseEnter: onShowRemoveConnector, onMouseLeave: onHideRemoveConnector }), (0, jsx_runtime_1.jsx)("path", { className: linkClassName, d: d, style: { animationDuration: `${edgeAnimationDuration}s` } }), showTag && ((0, jsx_runtime_1.jsx)("g", Object.assign({ transform: `scale(${hover ? tagScale : 1})` }, { children: (0, jsx_runtime_1.jsx)(DefaultConnectorTag_1.default, { className: tagClass, startPoint: element.getStartPoint().scale(tagPositionScale), endPoint: element.getEndPoint().scale(tagPositionScale), tag: tag, status: tagStatus }) }))), (0, jsx_runtime_1.jsx)(DefaultConnectorTerminal_1.default, { className: startTerminalClass, isTarget: false, edge: element, size: startTerminalSize, dragRef: sourceDragRef, terminalType: startTerminalType, status: startTerminalStatus, highlight: dragging || hover }), (0, jsx_runtime_1.jsx)(DefaultConnectorTerminal_1.default, { className: endTerminalClass, isTarget: true, dragRef: targetDragRef, edge: element, size: endTerminalSize, terminalType: endTerminalType, status: endTerminalStatus, highlight: dragging || hover }), children] })) })));
});
const DefaultEdge = (_a) => {
    ...
    return ((0, jsx_runtime_1.jsx)(DefaultEdgeInner, Object.assign({ element: element, startTerminalType: startTerminalType, startTerminalSize: startTerminalSize, endTerminalType: endTerminalType, endTerminalSize: endTerminalSize }, rest)));
};
