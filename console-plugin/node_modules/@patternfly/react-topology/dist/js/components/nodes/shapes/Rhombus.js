...
const Rhombus = ({ className = (0, react_styles_1.css)(topology_components_1.default.topologyNodeBackground), width, height, filter, cornerRadius = shapeUtils_1.RHOMBUS_CORNER_RADIUS, dndDropRef }) => {
    ...
    return cornerRadius ? ((0, jsx_runtime_1.jsx)("path", { className: className, ref: refs, d: points, filter: filter })) : ((0, jsx_runtime_1.jsx)("polygon", { className: className, ref: refs, points: points, filter: filter }));
};
