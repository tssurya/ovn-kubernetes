...
const ContextSubMenuItem = (_a) => {
    ...
    const referenceCb = (0, react_1.useCallback)(() => nodeRef.current || { x: 0, y: 0 }, []);
    return ((0, jsx_runtime_1.jsxs)(jsx_runtime_1.Fragment, { children: [(0, jsx_runtime_1.jsxs)(react_core_1.DropdownItem, Object.assign({}, other, { className: (0, react_styles_1.css)(topology_components_1.default.topologyContextSubMenu), ref: nodeRef, 
                ...
                onMouseEnter: () => setOpen(true), onMouseLeave: (e) => {
                ...
                } }, { children: [label, (0, jsx_runtime_1.jsx)(angle_right_icon_1.default, { className: (0, react_styles_1.css)(topology_components_1.default.topologyContextSubMenuArrow) })] })), (0, jsx_runtime_1.jsx)(Popper_1.default, Object.assign({ className: (0, react_styles_1.css)(topology_components_1.default.topologyContextSubMenuContainer), open: open, placement: "right-start", closeOnEsc: true, closeOnOutsideClick: true, onRequestClose: (e) => {
                ...
                }, reference: referenceCb, container: (_b = nodeRef.current) === null || _b === void 0 ? void 0 : _b.closest('.pf-v6-c-menu__content'), returnFocus: true }, { children: (0, jsx_runtime_1.jsx)(react_core_1.Menu, Object.assign({ onMouseLeave: (e) => {
                    ...
                    }, ref: subMenuRef, role: "presentation", isNavFlyout: true }, { children: children })) }))] }));
};
