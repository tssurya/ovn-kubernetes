...
const DefaultGroupInner = (0, mobx_react_1.observer)((_a) => {
    ...
    if (element.isCollapsed()) {
        return ((0, jsx_runtime_1.jsx)(DefaultGroupCollapsed_1.default, Object.assign({ className: className, element: element, onCollapseChange: handleCollapse }, rest)));
    }
    return (0, jsx_runtime_1.jsx)(DefaultGroupExpanded_1.default, Object.assign({ className: className, element: element, onCollapseChange: handleCollapse }, rest));
});
const DefaultGroup = (_a) => {
    ...
    return (0, jsx_runtime_1.jsx)(DefaultGroupInner, Object.assign({ element: element }, rest));
};
