...
const TaskEdgeInner = observer(({ element, startTerminalType = EdgeTerminalType.none, startTerminalClass, startTerminalStatus, startTerminalSize = 14, endTerminalType = EdgeTerminalType.none, endTerminalClass, endTerminalStatus, endTerminalSize = 14, className, nodeSeparation, selected, onSelect }) => {
    ...
    const edgeBackground = (_jsx("path", { onClick: onSelect, className: css(styles.topologyEdgeBackground, onSelect && 'pf-m-selectable'), d: edgePath }));
    return (_jsxs("g", Object.assign({ "data-test-id": "task-handler", className: groupClassName }, { children: [selected ? edgeBackground : _jsx(Layer, Object.assign({ id: TOP_LAYER }, { children: edgeBackground })), _jsx("path", { d: edgePath, transform: "translate(0.5,0.5)", shapeRendering: "geometricPrecision", fillOpacity: 0 }), _jsx(DefaultConnectorTerminal, { className: startTerminalClass, isTarget: false, edge: element, size: startTerminalSize, terminalType: startTerminalType, status: startTerminalStatus }), _jsx(DefaultConnectorTerminal, { className: endTerminalClass, isTarget: true, edge: element, size: endTerminalSize, terminalType: endTerminalType, status: endTerminalStatus, startPoint: verticalLayout ? endPoint.clone().translate(0, -1) : endPoint.clone().translate(-1, 0) })] })));
});
const TaskEdge = (_a) => {
    ...
    return _jsx(TaskEdgeInner, Object.assign({ element: element }, rest));
};
