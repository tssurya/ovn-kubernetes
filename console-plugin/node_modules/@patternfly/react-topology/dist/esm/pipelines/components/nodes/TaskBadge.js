...
const TaskBadge = forwardRef(({ badge, badgeTextColor, badgeColor, badgeBorderColor, badgeClassName, className, x, y }, iconRef) => {
    ...
    return (_jsxs("g", Object.assign({ className: classes, transform: `translate(${x}, ${y})` }, { children: [rect, typeof badge === 'string' ? (_jsx("text", Object.assign({ style: {
                    fill: badgeTextColor || badgeClassName ? undefined : defaultBadgeTextColor.value
                }, ref: textRef, x: width / 2 + paddingX, y: height / 2, textAnchor: "middle", dy: "0.35em" }, { children: badge }))) : (_jsx("foreignObject", Object.assign({ ref: textRef }, { children: badge })))] })));
});
