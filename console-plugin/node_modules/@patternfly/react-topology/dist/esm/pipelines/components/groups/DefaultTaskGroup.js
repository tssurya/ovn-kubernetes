...
const DefaultTaskGroupInner = observer((_a) => {
    ...
    if (element.isCollapsed()) {
        return (_jsx(DefaultTaskGroupCollapsed, Object.assign({ element: element, shadowCount: collapsedShadowCount, onCollapseChange: handleCollapse, badge: badge || `${childCount}` }, rest)));
    }
    return _jsx(DefaultTaskGroupExpanded, Object.assign({ element: element, badge: badge, onCollapseChange: handleCollapse }, rest));
});
const DefaultTaskGroup = (_a) => {
    ...
    return (_jsx(DefaultTaskGroupInner, Object.assign({ element: element, badgeColor: badgeColor, badgeBorderColor: badgeBorderColor, badgeTextColor: badgeTextColor }, rest)));
};
