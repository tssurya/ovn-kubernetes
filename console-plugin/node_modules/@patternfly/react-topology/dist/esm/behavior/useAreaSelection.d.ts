...
export declare const withAreaSelection: (modifier?: ModifierKey[]) => <P extends WithAreaSelectionProps>(WrappedComponent: import("react").ComponentType<P>) => import("react").FunctionComponent<Omit<P, keyof WithAreaSelectionProps>>;
