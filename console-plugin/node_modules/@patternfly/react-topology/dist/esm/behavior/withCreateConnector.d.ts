...
import { Graph, GraphElement, Node } from '../types';
...
export declare const withCreateConnector: <P extends WithCreateConnectorProps & ElementProps>(onCreate: React.ComponentProps<typeof CreateConnectorWidget>['onCreate'], ConnectorComponent?: CreateConnectorRenderer, contextMenuClass?: string, options?: CreateConnectorOptions) => (WrappedComponent: import("react").ComponentType<P>) => import("react").FunctionComponent<Omit<P, keyof WithCreateConnectorProps>>;
export {};
