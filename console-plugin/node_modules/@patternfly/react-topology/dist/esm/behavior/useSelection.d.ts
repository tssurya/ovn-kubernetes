...
export declare const withSelection: (options?: Options) => <P extends WithSelectionProps>(WrappedComponent: import("react").ComponentType<P>) => import("react").FunctionComponent<Omit<P, keyof WithSelectionProps>>;
export {};
