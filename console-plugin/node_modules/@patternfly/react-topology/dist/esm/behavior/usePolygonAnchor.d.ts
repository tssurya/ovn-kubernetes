...
export declare const withPolygonAnchor: <P extends {} = {}>(getPoints: (element: Node) => PointTuple[], end?: AnchorEnd, type?: string) => (WrappedComponent: import("react").ComponentType<P>) => import("react").FunctionComponent<P>;
