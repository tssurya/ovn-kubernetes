...
const DefaultConnectorTag = (_a) => {
    ...
    return (_jsxs("g", Object.assign({ className: css(styles.topologyEdgeTag, className, StatusModifier[status]), transform: `translate(${startPoint.x + (endPoint.x - startPoint.x) * 0.5}, ${startPoint.y + (endPoint.y - startPoint.y) * 0.5})` }, { children: [textSize && (_jsx("rect", { className: css(styles.topologyEdgeTagBackground), x: startX, y: startY, width: width, height: height, rx: 3, ry: 3 })), _jsx("text", Object.assign({ dy: "0.35em" }, other, { ref: textRef, x: startX + paddingX, y: 0 }, { children: tag }))] })));
};
