...
const DefaultEdgeInner = observer(({ element, dragging, sourceDragRef, targetDragRef, dndDropRef, canDrop, dropTarget, edgeStyle, animationDuration, onShowRemoveConnector, onHideRemoveConnector, startTerminalType = EdgeTerminalType.none, startTerminalClass, startTerminalStatus, startTerminalSize = 14, endTerminalType = EdgeTerminalType.directional, endTerminalClass, endTerminalStatus, endTerminalSize = 14, tag, tagClass, tagStatus, children, className, selected, onSelect, onContextMenu }) => {
    ...
    return (_jsx(Layer, Object.assign({ id: dragging || hover ? TOP_LAYER : undefined }, { children: _jsxs("g", Object.assign({ ref: edgeRef, "data-test-id": "edge-handler", className: groupClassName, onClick: onSelect, onContextMenu: onContextMenu }, { children: [_jsx("path", { className: css(styles.topologyEdgeBackground), d: backgroundPath, onMouseEnter: onShowRemoveConnector, onMouseLeave: onHideRemoveConnector }), _jsx("path", { className: linkClassName, d: d, style: { animationDuration: `${edgeAnimationDuration}s` } }), showTag && (_jsx("g", Object.assign({ transform: `scale(${hover ? tagScale : 1})` }, { children: _jsx(DefaultConnectorTag, { className: tagClass, startPoint: element.getStartPoint().scale(tagPositionScale), endPoint: element.getEndPoint().scale(tagPositionScale), tag: tag, status: tagStatus }) }))), _jsx(DefaultConnectorTerminal, { className: startTerminalClass, isTarget: false, edge: element, size: startTerminalSize, dragRef: sourceDragRef, terminalType: startTerminalType, status: startTerminalStatus, highlight: dragging || hover }), _jsx(DefaultConnectorTerminal, { className: endTerminalClass, isTarget: true, dragRef: targetDragRef, edge: element, size: endTerminalSize, terminalType: endTerminalType, status: endTerminalStatus, highlight: dragging || hover }), children] })) })));
});
const DefaultEdge = (_a) => {
    ...
    return (_jsx(DefaultEdgeInner, Object.assign({ element: element, startTerminalType: startTerminalType, startTerminalSize: startTerminalSize, endTerminalType: endTerminalType, endTerminalSize: endTerminalSize }, rest)));
};
