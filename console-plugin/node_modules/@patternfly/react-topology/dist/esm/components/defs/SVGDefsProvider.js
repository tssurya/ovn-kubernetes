 ...
 */
class SVGDefsProvider extends Component {
    constructor() {
        super(...arguments);
        this.defsRef = createRef();
        this.defs = {};
        this.contextValue = {
            addDef: (id, node) => {
    ...
    render() {
        return (_jsxs(SVGDefsContext.Provider, Object.assign({ value: this.contextValue }, { children: [_jsx(Defs, { ref: this.defsRef }), this.props.children] })));
    }
}
