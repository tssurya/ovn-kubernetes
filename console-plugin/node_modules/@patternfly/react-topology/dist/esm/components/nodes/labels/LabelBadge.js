...
const LabelBadge = forwardRef(({ badge, badgeTextColor, badgeColor, badgeBorderColor, badgeClassName, className, x, y, innerRef }, iconRef) => {
    ...
    return (_jsxs("g", Object.assign({ className: classes, transform: `translate(${x}, ${y})`, ref: innerRef }, { children: [rect, _jsx("text", Object.assign({ style: { fill: badgeTextColor || badgeClassName ? badgeTextColor : defaultBadgeTextColor.value }, ref: textRef, x: width / 2 + paddingX, y: height / 2, textAnchor: "middle", dy: "0.35em" }, { children: badge }))] })));
});
