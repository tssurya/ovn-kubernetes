...
const getStatusIcon = (status) => {
    switch (status) {
        case NodeStatus.danger:
            return _jsx(ExclamationCircleIcon, { className: "pf-m-danger" });
        case NodeStatus.warning:
            return _jsx(ExclamationTriangleIcon, { className: "pf-m-warning" });
        case NodeStatus.success:
            return _jsx(CheckCircleIcon, { className: "pf-m-success" });
        default:
            return null;
    }
};
...
const DefaultNodeInner = observer(({ className, element, selected, hover, scaleNode, showLabel = true, label, secondaryLabel, labelClassName, labelPosition, scaleLabel, truncateLength, labelIconClass, labelIcon, labelIconPadding, nodeStatus, showStatusBackground, showStatusDecorator = false, statusDecoratorTooltip, getCustomShape, getShapeDecoratorCenter, onStatusDecoratorClick, badge, badgeColor, badgeTextColor, badgeBorderColor, badgeClassName, badgeLocation, onSelect, children, attachments, dragNodeRef, dragging, edgeDragging, canDrop, dropTarget, dndDropRef, onHideCreateConnector, onShowCreateConnector, onContextMenu, contextMenuOpen, raiseLabelOnHover = true, hideContextMenuKebab }) => {
    ...
    const statusDecorator = useMemo(() => {
        ...
        const decorator = (_jsx(Decorator, { x: x, y: y, radius: DEFAULT_DECORATOR_RADIUS, showBackground: true, onClick: (e) => onStatusDecoratorClick(e, element), icon: _jsx("g", Object.assign({ className: css(styles.topologyNodeDecoratorStatus) }, { children: icon })), ariaLabel: status, innerRef: decoratorRef }));
        if (statusDecoratorTooltip) {
            return (_jsx(Tooltip, Object.assign({ triggerRef: decoratorRef, content: statusDecoratorTooltip, position: TooltipPosition.left }, { children: decorator })));
        }
        return decorator;
...
const DefaultNode = (_a) => {
    ...
    return (_jsx(DefaultNodeInner, Object.assign({ element: element, showLabel: showLabel, showStatusDecorator: showStatusDecorator }, rest)));
};
