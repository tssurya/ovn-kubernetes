...
const Rhombus = ({ className = css(styles.topologyNodeBackground), width, height, filter, cornerRadius = RHOMBUS_CORNER_RADIUS, dndDropRef }) => {
    ...
    return cornerRadius ? (_jsx("path", { className: className, ref: refs, d: points, filter: filter })) : (_jsx("polygon", { className: className, ref: refs, points: points, filter: filter }));
};
