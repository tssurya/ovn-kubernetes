...
const SidedShape = ({ className = css(styles.topologyNodeBackground), width, height, filter, sides = 6, cornerRadius = 0, dndDropRef }) => {
    ...
    return cornerRadius ? (_jsx("path", { className: className, ref: dndDropRef, d: points, filter: filter })) : (_jsx("polygon", { className: className, ref: dndDropRef, points: points, filter: filter }));
};
