...
const getWebpackSharedModules = () => {
    ...
    return shared_modules_meta_1.sharedPluginModules.reduce((acc, moduleName) => {
...
class ConsoleRemotePlugin {
    ...
    apply(compiler) {
        ...
        compiler.hooks.thisCompilation.tap(ConsoleRemotePlugin.name, (compilation) => {
            ...
            compiler.webpack.NormalModule.getCompilationHooks(compilation).beforeLoaders.tap(ConsoleRemotePlugin.name, (loaders, normalModule) => {
