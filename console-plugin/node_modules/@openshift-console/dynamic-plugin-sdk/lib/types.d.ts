import type { CodeRef as SDKCodeRef, ExtensionFlags, ExtensionPredicate, LoadedExtension as SDKLoadedExtension, ReplaceProperties as Update, MapCodeRefsToValues } from '@openshift/dynamic-plugin-sdk';
export type { ExtensionFlags, Extension as ExtensionDeclaration, MapCodeRefsToValues as ResolvedCodeRefProperties, PluginEntryModule as RemoteEntryModule, ReplaceProperties as Update, } from '@openshift/dynamic-plugin-sdk';
/**
 ...
 */
export type ResolvedExtension<E extends Extension<P>, P = ExtensionProperties<E>> = LoadedExtension<UpdateExtensionProperties<E, MapCodeRefsToValues<P>, P>>;
