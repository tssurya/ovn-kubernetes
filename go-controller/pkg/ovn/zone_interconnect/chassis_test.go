...
var _ = ginkgo.Describe("Zone Interconnect Chassis Operations", func() {
	...
	ginkgo.It("chassis is-remote check", func() {
		app.Action = func(ctx *cli.Context) error {
			...
			gomega.Expect(err).NotTo(gomega.HaveOccurred())
			gomega.Expect(nodeCh.ExternalIDs).Should(gomega.HaveKeyWithValue("is-remote", "false"))
			...
			gomega.Expect(err).NotTo(gomega.HaveOccurred())
			gomega.Expect(nodeCh.ExternalIDs).Should(gomega.HaveKeyWithValue("is-remote", "true"))
